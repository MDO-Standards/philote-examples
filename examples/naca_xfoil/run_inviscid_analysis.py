"""Coupled NACA + XFOIL inviscid analysis using OpenMDAO clients.

Starts NACA and XFOIL Philote servers in-process, builds an OpenMDAO
model that chains them, and evaluates inviscid aerodynamic coefficients
for a specified NACA 4-digit airfoil (no Reynolds or Mach inputs).
...
def run(
    ...
    """Run a coupled NACA -> XFOIL inviscid analysis.
