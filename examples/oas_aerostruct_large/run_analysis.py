"""OpenAeroStruct aerostructural analysis with a large CRM wing mesh.

Same analysis as the small-mesh ``oas_aerostruct`` example but with 21
spanwise and 7 chordwise panels for higher fidelity.
...
def run(
    ...
    """Run an OAS aerostructural analysis (large mesh).
    ...
    """
    if start_server:
        oas_server = _start_server(OasAerostructDiscipline(mesh_dict=MESH_DICT), PORT)
    ...
    try:
        ...
        print(
            f"OAS aerostructural analysis (large mesh): v={v} m/s, "
